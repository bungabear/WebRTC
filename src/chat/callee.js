...
function onSend(){
    ...
    document.querySelector("div#receive").innerHTML += '<br/>' + 'you : ' + msg.msg;
    ...
    if (obj.code == '99') {
        ...
        try{
            ...
            if(msg.code == '02'){
                ...
                console.info('sendChannel.onmessage : ' + msg.msg);
                document.querySelector("div#receive").innerHTML += '<br/>' + 'other :'  + msg.msg;
            }
        } catch(e) {
...
function onStart() {
    ...
    var url = 'ws://127.0.0.1:3000/room/' + roodId.value;
